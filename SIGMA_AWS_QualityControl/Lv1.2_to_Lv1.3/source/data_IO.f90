...
!---------------------------------------------------------------------------------------------------------------------------  
subroutine data_inputA (infile, date_time, &
  ...
  real(8), intent(out)      :: param21(:), param22(:), param23(:), param24(:)
  ...
  open (10, iostat=ios, file=infile, status='old', form='formatted')
    ...
    do i = 1, size(date_time)
      read(10,*) date_time(i), &
               ...
               & param21(i), param22(i), param23(i), param24(i)
      if (i == 1) then
        print *, i, date_time(i), &
                  & param1(i), param2(i), param3(i), param4(i), param5(i), &
                  & param6(i), param7(i), param8(i), param9(i), param10(i), &
...
end subroutine data_inputA

!---------------------------------------------------------------------------------------------------------------------------
subroutine data_inputB (infile, date_time, &
                     & param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, &
                     & param11, param12)
  implicit none
  ...
  real(8), intent(out)      :: param1(:), param2(:), param3(:), param4(:), param5(:)
  real(8), intent(out)      :: param6(:), param7(:), param8(:), param9(:), param10(:)
  real(8), intent(out)      :: param11(:), param12(:)
...
subroutine data_writing (site_name, ndata, cell, date_time, &
  ...
  real(8), intent(in) :: param21(:), param22(:), param23(:), param24(:), param25(:)
  real(8), intent(in) :: param26(:), param27(:), param28(:), param29(:), param30(:)
  real(8), intent(in) :: param31(:), param32(:), param33(:), param34(:), param35(:)
  real(8), intent(in) :: param36(:), param37(:), param38(:), param39(:), param40(:)
...
!  character(2) :: cday
  ...
  do i = 1, size(date_time)
!    write(cyear,'(I4.4)') year(i)
!    write(cmonth,'(I2.2)') month(i)
!    write(cday,'(I2.2)') day(i)
...
!>>> appending parameters
  ...
  if (site_name == 'SIGMA-A') then
    ...
    call column (cell, column_number, 'albedo', ndata, param25)
    call column (cell, column_number, 'daily_integrated_albedo', ndata, param26)
    call column (cell, column_number, 'nir_albedo', ndata, param27)
    call column (cell, column_number, 'daily_integrated_nir_albedo', ndata, param28)
    call column (cell, column_number, 'nir_frac', ndata, param29)
    call column (cell, column_number, 'sensor_height1', ndata, param30)
    call column (cell, column_number, 'sensor_height2', ndata, param31)
    call column (cell, column_number, 'Ts', ndata, param32)
    call column (cell, column_number, 'st1_depth', ndata, param33)
    call column (cell, column_number, 'st2_depth', ndata, param34)
    call column (cell, column_number, 'st3_depth', ndata, param35)
    call column (cell, column_number, 'st4_depth', ndata, param36)
    call column (cell, column_number, 'st5_depth', ndata, param37)
    call column (cell, column_number, 'st6_depth', ndata, param38)
  end if
...
!    call column (cell, column_number, 'NIRu', ndata, param14)
    ...
    call column (cell, column_number, 'solz', ndata, param23)
    call column (cell, column_number, 'sola', ndata, param24)
    call column (cell, column_number, 'SWd_slope', ndata, param40)
    call column (cell, column_number, 'albedo', ndata, param25)
    call column (cell, column_number, 'daily_integrated_albedo', ndata, param26)
!    call column (cell, column_number, 'nir_albedo', ndata, param27)
!    call column (cell, column_number, 'daily_integrated_nir_albedo', ndata, param28)
!    call column (cell, column_number, 'nir_frac', ndata, param29)
    call column (cell, column_number, 'sensor_height1', ndata, param30)
    call column (cell, column_number, 'Ts', ndata, param32)
    call column (cell, column_number, 'solz_slope', ndata, param39)    
  end if
